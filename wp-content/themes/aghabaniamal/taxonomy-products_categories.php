            ...
            <div class="widget wg-categories">
              ...
              <div class="wg-body">
                <ul class="wg-categories-list">
                  <li>Our Products <span class="wgc-count">(<?php echo(wp_count_posts( 'products' )->publish); ?>)</span>
                  <?php
    ...
    <ul>
        ...
        <?php if($term->parent==0) { ?>
            <li><a href="<?php echo get_term_link($term->slug, $taxonomy); ?>"><?php echo $term->name; ?></a>
                 <?php
                        $taxonomy = 'products_categories';
                        $terms0 = get_terms($taxonomy);
                        if ( $terms0 && !is_wp_error( $terms0 ) ) :
                         foreach ( $terms0 as $term0 ) { 
                            if($term0->parent!=0 AND $term0->parent==$term->term_id) { ?>
                                <ul>
