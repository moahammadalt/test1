      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-5 col-xs-12 product-info">
          ...
          <p class="data-info">Product Tags: 
            <span>
              <?php
               $tags = get_the_terms( $post_id , 'tables_tags' );
                     foreach ($tags as $tag) {
                         echo ($tag->name);
                         echo (", ");
                     }
          ...
          <span>
              <?php
               $tags = get_the_terms( $post_id , 'table_categories' );
                     foreach ($tags as $tag) {
                         echo ($tag->name);
                         echo (", ");
                     }
...
$related = new WP_Query( ( array( 'category__in' => wp_get_post_categories($post_id), 'posts_per_page' => 2, 'post__not_in' => array($post_id), 'post_type'=>'table_runners' ) ));
